...
export default function hasilTes() {
  ...
  const [selectedPosition, setSelectedPosition] = useState<OpsiPosisi | null>(
    null,
  );
    ...
    <div className="">
        ...
        <div className="w-full">
          <div className="flex gap-x-2">
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm shadow-sm outline-none transition-all duration-200 placeholder:text-gray-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
            />
            ...
            >
              ...
              <svg
                ...
                className="h-5 w-5 hover:text-gray-200 text-white"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex gap-1 items-center">
                ...
                <input
                  ...
                  className="rounded-2xl border border-gray-200 bg-white px-4 py-3 -sm shadow-sm outline-none transition-all duration-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                />
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm shadow-sm outline-none transition-all duration-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                />
              </div>
            </div>
          </div>
      ...
      <div className="mt-6 flex flex-col gap-4 rounded-3xl border border-gray-200 bg-white px-6 py-4 shadow-sm md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 rounded-2xl bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-700">
