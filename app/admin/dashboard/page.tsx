    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md">
          ...
          <div className="mt-5 text-5xl font-bold text-gray-800">4</div>
        </div>

        {/* Card */}
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md">
          <div className="text-sm font-medium text-gray-500">Total Peserta</div>

          <div className="mt-5 text-5xl font-bold text-gray-800">6</div>
        </div>

        {/* Card */}
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md">
          <div className="text-sm font-medium text-gray-500">Hasil Tes</div>

          <div className="mt-5 text-5xl font-bold text-gray-800">8</div>
        </div>
      </div>
