    ...
    <div>
      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            <div className="mb-4">
              <p className="text-lg font-semibold text-gray-800">Jenis Tes</p>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              ...
              <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-blue-300 hover:bg-blue-50">
                ...
                />
                <span className="font-medium text-gray-700">CFIT</span>
              </label>
              ...
              <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-blue-300 hover:bg-blue-50">
                <input
                  ...
                  onChange={handleChange}
                />
                <span className="font-medium text-gray-700">DISC</span>
              </label>
              ...
              <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-blue-300 hover:bg-blue-50">
                <input
                  ...
                  onChange={handleChange}
                />
                <span className="font-medium text-gray-700">Kraepelin</span>
              </label>
              ...
              <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-blue-300 hover:bg-blue-50">
                <input
                  ...
                  onChange={handleChange}
                />
                <span className="font-medium text-gray-700">MSDT</span>
              </label>
              ...
              <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-200 hover:border-blue-300 hover:bg-blue-50">
                <input
                  ...
                  onChange={handleChange}
                />
                <span className="font-medium text-gray-700">PapiKostick</span>
              </label>
            </div>
