          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <p className="text-gray-700 mb-4">
                Pada subtes ini, Anda akan mengamati posisi sebuah titik di
                antara susunan bangunan. Baca dengan saksama petunjuk di bawah
                ini:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  Setiap soal menyajikan susunan beberapa bangunan beserta
                  sebuah titik.
                </li>
                <li>
                  Perhatikan dengan saksama posisi titik tersebut berada di area
                  bangunan mana saja.
                </li>
                <li>
                  Pilih gambar dari opsi jawaban yang memiliki posisi titik yang
                  sama persis dengan soal.
                </li>
                ...
                <li>
                  ...
                  />
                  Waktu pengerjaan:{" "}
                  <span className="font-semibold">2 menit 30 detik</span>
                </li>
                <li>
                  Jumlah soal: <span className="font-semibold">10 butir</span>
                </li>
              </ul>
            </div>
          </section>
                ...
                <div className="w-full flex flex-col gap-3 text-gray-400 italic">
                  <div>
                    <p className="text-center">
                      Amati posisi titik di antara bangunan berikut dan cari
                      gambar dengan letak titik yang serupa dengan soal:
                    </p>
                  </div>
                  <div className="w-full grid grid-cols-1 md:grid-cols-1 gap-4 mb-6 text-gray-400 italic m-auto">
                    <div className="w-30 md:w-50 aspect-square bg-slate-100 rounded-xl mx-auto flex items-center justify-center text-slate-400 border border-slate-200">
                      <img
