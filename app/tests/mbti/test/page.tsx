              ...
              {questions.length > 0 ? (
                <div className="flex items-center gap-x-4">
                  ...
                  <div className=" text-base text-gray-800 font-mono px-4 py-2 rounded-lg shadow-sm bg-gray-100 border border-gray-200">
                    {questions.length > 0 ? (
                      <span>
                        Soal: {currentGroup + 1} / {questions.length}
                      </span>
                    ) : (
                      <span>Soal: --/--</span>
                    )}
              ...
              <div className="">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${((currentGroup + 1) / questions.length) * 100}%`,
                    }}
                  />
                </div>
              </div>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 gap-4 w-full">
                          <p className="text-lg font-bold  text-gray-700">
                            {questions[currentGroup]?.question}...
                          </p>
                          {questions[currentGroup]?.options.map(
                            (option, index) => {
                              const selected =
                              ...
                              return (
                                <div className="flex gap-3 " key={index}>
                                  <button
                                    onClick={() =>
                                      handleSelection(option.optionType)
                                    }
        ...
        <div className="flex gap-x-3 justify-evenly mt-4">
          ...
          {isLoading ? (
            ...
            <button
              onClick={handleTestComplete}
              disabled={
                (answers as any[]).includes(undefined) ||
                (answers as any[]).includes(null) ||
