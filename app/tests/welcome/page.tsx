      ...
      <div className="font-sans min-h-screen bg-gradient-to-br from-red-50 to-indigo-100">
            ...
            >
              <div>
                <div className="flex items-center mb-8 justify-between">
                  <div>
                    <h2 className="text-2xl text-left md:text-3xl font-bold text-slate-800">
                      Selamat Datang di Sesi Tes Anda
                    </h2>
                  </div>
                ...
                <p className="mt-3 text-base text-slate-700 text-left">
                  Pendaftaran Anda telah berhasil dan data Anda telah
                  diverifikasi oleh sistem. Pada tahap selanjutnya, Anda akan
                  mengikuti rangkaian tes psikologi sesuai dengan token yang
                  telah diberikan kepada Anda.
                  <span className="block mt-2">
                    Setiap tes memiliki tujuan dan aturan pengerjaan yang
                    berbeda. Oleh karena itu, sangat disarankan untuk membaca
                    petunjuk pada setiap tes dengan saksama sebelum memulai.
                  </span>
                </p>
                <div className="mt-8 bg-blue-50 p-5 border border-blue-200 rounded-lg">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-700">
                    <li className="flex gap-3 items-start">
                      ...
                      Pastikan Anda berada di tempat yang nyaman dan minim
                      gangguan.
                    </li>
                    <li className="flex gap-3 items-start">
                      <span className="flex-none mt-1 w-2.5 h-2.5 bg-slate-400 rounded-full"></span>
                    ...
                    <li className="flex gap-3 items-start">
                      <span className="flex-none mt-1 w-2.5 h-2.5 bg-slate-400 rounded-full"></span>
                      Jangan menutup atau memuat ulang halaman sebelum tes
                      selesai.
                    </li>
                  </ul>
                </div>
            ...
            >
              ...
              <div className="flex flex-col gap-y-3">
                <p className="text-slate-700">
                  Tes ini terdiri dari beberapa jenis tes dengan total soal dan
                  jumlah tes sebagai berikut:
                </p>
                        ...
                        {dataTests.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="px-5 py-3 font-semibold">
                              {testsQuestion(item)}
                              <span className="block font-normal">soal</span>
                            </td>
                          </tr>
                        ))}
                      </tbody>
        ...
        <div className=" shadow p-6 flex flex-col md:flex-col-reverse items-center justify-between gap-4 bg-white ">
          <div className="text-sm text-slate-600">
            ...
            diri anda telah siap dan fokus.
          </div>
          <div className="flex items-center gap-3">
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
              <p className="text-gray-800">
                Anda akan memasuki halaman petunjuk tes dan contoh soal. Silakan
                baca dengan saksama sebelum memulai tes.
              </p>
              <p className="text-gray-600 text-sm mt-3">
                (Pastikan koneksi internet stabil dan Anda berada di lingkungan
                yang kondusif.)
              </p>
